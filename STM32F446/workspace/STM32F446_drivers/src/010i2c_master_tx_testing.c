...
void I2C1_GPIOInits(void)
{
	...
	I2CPins.GPIO_Pin_Config.GPIO_PinMode = GPIO_MODE_ALTFN;
	I2CPins.GPIO_Pin_Config.GPIO_PinOPType = GPIO_OP_TYPE_OD;
	/*
	 ...
	 */
	I2CPins.GPIO_Pin_Config.GPIO_PinPuPdControl = GPIO_PU;
	I2CPins.GPIO_Pin_Config.GPIO_PinAltFunMode = 4;
	I2CPins. GPIO_Pin_Config.GPIO_PinSpeed = GPIO_SPEED_FAST;

	//scl
	I2CPins.GPIO_Pin_Config.GPIO_PinNumber = GPIO_PIN_NO_6;
	GPIO_Init(&I2CPins);


	//sda
	//Note : since we found a glitch on PB9 , you can also try with PB7
	I2CPins.GPIO_Pin_Config.GPIO_PinNumber = GPIO_PIN_NO_9;
...
void GPIO_ButtonInit(void)
{
	...
	GPIOBtn.GPIO_Pin_Config.GPIO_PinNumber = GPIO_PIN_NO_0;
	GPIOBtn.GPIO_Pin_Config.GPIO_PinMode = GPIO_MODE_IN;
	GPIOBtn.GPIO_Pin_Config.GPIO_PinSpeed = GPIO_SPEED_FAST;
	GPIOBtn.GPIO_Pin_Config.GPIO_PinPuPdControl = GPIO_NO_PUPD;
